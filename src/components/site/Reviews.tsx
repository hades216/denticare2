...
const Reviews = () => {
  ...
  const displayed = useMemo(
    () => (mounted ? shuffle([...userReviews, ...seedReviews]) : [...userReviews, ...seedReviews]),
    [userReviews, mounted],
  );
    ...
    <section id="reviews" className="relative py-24 lg:py-32 bg-soft-gradient overflow-hidden">
      <div className="container relative z-10">
        ...
        <div className="mt-20 max-w-2xl mx-auto">
          ...
          >
            <div>
              <label className="text-sm font-medium text-primary-deep mb-2 block">Your Name</label>
              <Input
                value={name}
            ...
            <fieldset>
              <legend className="text-sm font-medium text-primary-deep mb-2 block">Rating</legend>
              <div className="flex items-center gap-1" onMouseLeave={() => setHover(0)}>
                ...
                <span className="ml-2 text-sm font-semibold text-primary-deep">{rating}/5</span>
              </div>
            </fieldset>
            ...
            <div>
              ...
              <Textarea
                ...
                required
              />
              <div className="text-xs text-muted-foreground mt-1 text-right">{text.length}/800</div>
            </div>
