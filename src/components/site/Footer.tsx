...
const Footer = () => (
  <footer
    id="contact"
    className="relative bg-primary-deep text-primary-foreground pt-20 pb-8 overflow-hidden"
  >
      ...
      <div className="grid md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          ...
          <p className="text-primary-foreground/70 max-w-md leading-relaxed">
            Premium dental care in Islamabad — led by Asst. Prof. Dr. Muhammad Omer Siddiqui (BDS,
            MHPE). Your smile, our priority.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-primary-foreground/70">
            <li className="flex gap-2">
              <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0" /> Options Arcade, Main Road, PWD,
              Islamabad
            </li>
            <li className="flex gap-2">
              <Phone className="w-4 h-4 mt-0.5 flex-shrink-0" />{" "}
              <a href="tel:+923335299143" className="hover:text-primary-foreground">
                0333 5299143
              </a>
            </li>
            <li className="flex gap-2">
              <Clock className="w-4 h-4 mt-0.5 flex-shrink-0" /> 5:00 PM – 8:30 PM · Closed Sundays
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-1.5 text-sm text-primary-foreground/70">
            {[
              ...
              <li key={day} className="flex justify-between gap-4">
                ...
                <span
                  className={
                    time === "Closed" ? "text-accent font-medium" : "text-primary-foreground/90"
                  }
                >
                  {time}
                </span>
          ...
          <div className="flex gap-3 mt-5">
            <a
              href="https://www.instagram.com/denticaredc/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram"
              className="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 grid place-items-center transition-colors"
            >
              <Instagram className="w-4 h-4" />
            </a>
            <a
              href="https://www.facebook.com/DenticareDC/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook"
              className="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 grid place-items-center transition-colors"
